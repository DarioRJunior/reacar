    ...
    return (
        <div className="w-full flex justify-center bg-gray-100 min-h-screen">
            <Head>
                ...
                <meta property="og:description" content={"Don't forget to check" + nameSEO} />
                ...
                <div className="flex my-5">
                    <Link href="/cars" passHref>
                        ...
                        <a className="flex font-semibold py-2 px-4 hover:bg-gray-200 rounded">
                            <FiArrowLeft className="mr-2" size={24} />Voltar</a>
                    </Link>
                </div>
                <div className="w-full shadow p-3 mb-5 rounded"
                    key={car.id}
                >
